    """
    Symlink Manager Q22rzr
    ======================
    Productivity CLI tool that automates the task of renameing common file operations.
    ...
    APP_NAME    = "Symlink Manager Q22rzr"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Productivity CLI tool that automates the task of renameing common file operations.")
